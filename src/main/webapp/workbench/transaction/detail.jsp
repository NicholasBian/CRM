<%@ page import="com.bian.crm.workbench.domain.Tran" %>
<%@ page import="com.bian.crm.settings.domain.DicValue" %>
 ...
 */
	function changeStage(stage,i){
		...
		$.ajax({
			...
			success:function(data){
				if(data.success){
					//改变阶段成功后，需要在详细信息页上局部刷新 阶段 可能性 修改人 修改时间
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//判断当前阶段 如果当前阶段的可能性为0 前7个一定是黑圈，后两个一个是红叉一个是黑叉
			...
			//如果当前阶段的可能性不为0 前7个有可能是绿圈，绿色标记，黑圈，后两个一定是黑叉
				...
				%>
					...
					-------------
				<%
					}else{//遍历出的可能性不为0，说明是前7个阶段（绿圈，绿色标记，黑圈）
